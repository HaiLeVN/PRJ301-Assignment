...
public class UpdateItemServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String msg;
            int rs = ItemDAO.updateItem(Integer.parseInt(itemid.trim()), itemName.trim(), Integer.parseInt(itemPrice.trim()), Integer.parseInt(cateid.trim()));
            if (rs > 0) {
                msg = "Successfully updated";
            } else {
                msg = "Failed to update, cannot communicate to database";
            }
